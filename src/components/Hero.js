...
export default function Hero() {
  const config ={
    ...
    social:{
    github:"https://github.com/dhanushya0123/",
    whatsapp:"https://wa.me/9344868388/",
    instagram:"https://www.instagram.com/sunda_rking143/"
    } 
    ...
    return <section className='flex flex-col  md:flex-row px-5 py-32  bg-secondary justify-center ' id='hero'>
        <div className=' md:  w-1/2 flex flex-col'>
            <h1 className=' text-white text-4xl font hero-font '>Hi,<br/> iam dhanushya
